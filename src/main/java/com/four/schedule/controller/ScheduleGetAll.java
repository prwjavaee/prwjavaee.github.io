...
@WebServlet("/ScheduleGetAll")
public class ScheduleGetAll extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			request.getRequestDispatcher("/four/schedule/jsp/ScheduleGetAll.jsp").forward(request, response);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
