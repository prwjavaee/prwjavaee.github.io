...
@WebServlet("/ScheduleShowAll")
public class ScheduleShowAll extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			request.getRequestDispatcher("/four/schedule/jsp/ScheduleShowAll.jsp").forward(request, response);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
