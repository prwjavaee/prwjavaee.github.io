	...
	<div class="main-block">
		<div class="scheduleShowContainer">
			<div class="btnLike">
				...
				<a href="${pageContext.request.contextPath}/ScheduleList" class="link-btn2">查詢課程時間表</a>
			</div>
			<h2>課表</h2>
			    ...
			    for (String daytime : daytimes) {
			        ...
			        for (String weekday : weekdays) {
			            ...
			            if (!courseName.isEmpty()) {
			                ...
			                out.println("<a href=\"" + contextPath + "/CourseGetById?courseId=" + courseId + "\" style=\"color: black; text-decoration: none;\">" + courseName + "</a>");
			            } else {
